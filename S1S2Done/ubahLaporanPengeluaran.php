    ...
    if (ubahLaporan($_POST, $id_laporan) > 0) {
        echo "
            <script> 
                ...
                document.location.href = './laporanPengeluaran.php';
            </script>
            ";
    } else {
        echo "
        ...
        document.location.href = './ubahLaporanPengeluaran.php?id=$id_laporan';
        </script>
        ";
    }
    // $success = false;
...
<head>
    ...
    <title>Ubah Laporan Pengeluaran</title>
</head>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col mb-5">
                                <div class="d-flex justify-content-between">
                                    <a href="./laporanPengeluaran.php" class="btn btn-secondary"><strong>Kembali</strong></a>
