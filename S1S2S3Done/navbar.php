                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="./pemilik/shift_jam.php">Waktu Jam Kerja</a></li>
                            <li><a class="dropdown-item" href="./pemilik/shift_karyawan.php">Data Shift Karyawan</a></li>
                            <li><a class="dropdown-item" href="./pemilik/gaji.php">Gaji Karyawan</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
