...
$id_user = isset($_GET['id_user']) ? $_GET['id_user'] : $_SESSION['user']['id_user'];
...
$karyawans = query("SELECT * FROM users WHERE jabatan = 'karyawan'")
                ...
                <div class="col-md-7">
                    ...
                    <div id="content">
                        ...
                        <?php if ($_SESSION['user']['jabatan'] == 'pemilik') : ?>
                            <hr>
                            <a href="laporanGaji.php" class="btn btn-outline-primary col-12">Kembali</a>
                        <?php endif ?>
