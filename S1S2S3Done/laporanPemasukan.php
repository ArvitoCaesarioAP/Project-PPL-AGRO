...
if (isset($_POST['kirim'])) {
    ...
    $pemasukan = query("SELECT * FROM laporan_keuangan WHERE month(tanggal) = {$tanggal_mulai_trim[1]} AND year(tanggal) = {$tanggal_mulai_trim[0]}  AND nama_laporan = 'Pemasukan'");
}
